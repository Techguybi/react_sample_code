...
class Events extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({ eventOpen: nextProps.eventOpen });
    }
    ...
    render() {
        ...
        return (
            <div>
                <Modal open={this.state.eventOpen} onClose={this.onCloseModal} classNames="custom-modal-wrapper">
                                        ...
                                        <div className="report-content">
                                            <Form>
                                                <Form.Group as={Row} controlId="formPlaintextEmail">
                                                    ...
                                                    <Col sm="8">
                                                    <Form.Control type="text" placeholder="Events" />
                                                    </Col>
                                                </Form.Group>
