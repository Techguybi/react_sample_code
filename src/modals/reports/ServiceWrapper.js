...
class ServiceWrapper extends Component {
    constructor(props) {
        ...
        this.state = {
            serviceWrapperLog: props.serviceWrapperLog,
        }
    }


    componentWillReceiveProps(nextProps) {
        this.setState({ serviceWrapperLog: nextProps.serviceWrapperLog });
    }

    onOpenModal = () => {
        this.setState({ serviceWrapperLog: true });
    };

    onCloseModal = () => {
        this.setState({ serviceWrapperLog: false });
    };
    ...
    render() {
        ...
        return (
            <div>
                <Modal open={this.state.serviceWrapperLog} onClose={this.onCloseModal} classNames="custom-modal-wrapper">
                    <div className="modal-popup reports-general-information">
                        <div className="modal-name">
                            <h6>Service wrapper log</h6>
                        </div>
