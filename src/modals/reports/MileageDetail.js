...
class MileageDetail extends Component {
    constructor(props) {
        super(props);
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({ mdopen: nextProps.mdopen });
    }
    ...
    render() {
        ...
        return (
            <div>
                <Modal open={this.state.mdopen} onClose={this.onCloseModal} classNames="custom-modal-wrapper">
                                        ...
                                        <div className="report-content">
                                            <Form>
                                                <Form.Group as={Row} controlId="formPlaintextEmail">
                                                    ...
                                                    <Col sm="8">
                                                    <Form.Control type="text" placeholder="Mileage Detail" />
                                                    </Col>
                                                </Form.Group>
                                                    ...
                                                    <Col sm="8">
                                                        <Dropdown>
                                                            ...
                                                            <Dropdown.Menu>
                                                                ...
                                                                <Dropdown.Item href="#/action-3">Overspeeds</Dropdown.Item>
